...
def apply_transform(image, scale, rotation, translation_x, translation_y, flip_horizontal):
    ...
    # Get the center of the image (around which to rotate/scale)
    center_x, center_y = image.shape[1] // 2, image.shape[0] // 2

    # Create the affine transformation matrix for scaling and rotation
    ...
    transformed_image = cv2.warpAffine(image, transformation_matrix[:2], (image.shape[1], image.shape[0]), borderValue=(255, 255, 255))
